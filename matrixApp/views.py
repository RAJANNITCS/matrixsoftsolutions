...
def post_detail_view(request, year, month, day, post):
    ...
    if request.method == 'POST':
        ...
        form = CommentForm()
    return render(request, 'HtmlFile/post_detail.html', {'post_list': post_list, 'post': post, 'form': form, 'tag': tag, 'csubmit': csubmit, 'latest_posts': latest_posts, 'comments': comments})
